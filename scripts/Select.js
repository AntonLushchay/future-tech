...
class Select extends BaseComponent {
    ...
    constructor(rootElement) {
        ...
        this.optionsElement = this.dropdownElement.querySelectorAll(this.selectors.option);
        this.state = this.getProxyState({
            ...this.initialState,
            currentOptionIndex: this.originalControlElement.selectedIndex,
            selectedOptionElement: this.optionsElement[this.originalControlElement.selectedIndex],
        });
    ...
    updateUI() {
        ...
        const updateButton = () => {
            ...
            this.buttonElement.setAttribute(
                ...
                this.optionsElement[currentOptionIndex].id,
            );
        };
    ...
    selectCurrentOption() {
        this.state.selectedOptionElement = this.optionsElement[this.state.currentOptionIndex];
    }
    ...
    onClick = (event) => {
        ...
        if (isOptionClick) {
            ...
            this.state.currentOptionIndex = [...this.optionsElement].findIndex(
    ...
    onArrowDownKeyDown = () => {
        ...
        if (this.state.currentOptionIndex < this.optionsElement.length - 1) {
            this.state.currentOptionIndex++;
        }
    };
    ...
    onOriginalControlChange = () => {
        this.state.selectedOptionElement = this.optionsElement[this.originalControlElement.selectedIndex];
    };
